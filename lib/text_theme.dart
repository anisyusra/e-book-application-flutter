...
class TTextTheme{
  static TextTheme lightTextTheme = TextTheme(
    ...
    // headline5: GoogleFonts.poppins(fontSize: 14.0, fontWeight: FontWeight.bold, color: tDarkColor),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    // headline5: GoogleFonts.poppins(fontSize: 14.0, fontWeight: FontWeight.w600, color: tWhiteColor),
